    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-4 font-sans relative overflow-hidden">
      ...
      <Card className="w-full max-w-md glass-panel shadow-2xl rounded-3xl overflow-hidden relative z-10 border-white/20">
        <CardHeader className="space-y-1 flex flex-col items-center pt-10">
          ...
          <CardTitle className="text-3xl font-black text-primary uppercase tracking-tighter">Get Started</CardTitle>
          <CardDescription className="text-slate-400 font-medium">Create your MindNote AI account</CardDescription>
        </CardHeader>
        <form onSubmit={handleSubmit}>
          <CardContent className="space-y-4 px-8 pt-6">
            <div className="space-y-2">
              <label className="text-xs font-black text-primary uppercase tracking-wider ml-1">Full Name</label>
              <Input 
                type="text" 
            ...
            <div className="space-y-2">
              <label className="text-xs font-black text-primary uppercase tracking-wider ml-1">Password</label>
              <Input 
                type="password" 
                required 
                value={password}
